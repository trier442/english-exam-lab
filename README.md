...
2027 수능특강 영어 연계형 자체 제작 지문·변형문제와 영어독해연습·영어듣기 학습 자료를 제공하는 독립 정적 사이트입니다.

## 구성

- `index.html`: 메인 페이지
- `2027-suneung-english.html`: 수능특강 영어 30강·Test 3회 자체 제작 변형문제 69문항
...
교재 원문, 문항, 정답, 음원, 단어장을 복제하지 않습니다. 교재의 강별 유형에 연계한 영어 지문, 선택지와 해설을 새로 작성합니다.
